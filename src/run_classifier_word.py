...
def main():
    ...
    print("test accumulationstep1:", args.train_batch_size, args.gradient_accumulation_steps, args.num_train_epochs)
...
#    os.makedirs(args.output_dir, exist_ok=True)
    ...
    if args.do_train:
        ...
        logger.info("train label_list.size:%d\n" % (len(label_list)))
    elif args.do_eval:
        eval_examples = processor.get_dev_examples(args.data_dir)
        label_list = processor.get_labels()
    else:
        raise ValueError(" at least one of do_eval, do_train should be given")
...
###########################################################################
    ...
    if args.do_eval:
        eval_examples = processor.get_dev_examples(args.data_dir)
        label_list = processor.get_labels()
        logger.info("eval label_list.size:%d\n" % (len(label_list)))
